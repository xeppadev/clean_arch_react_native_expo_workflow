      ...
      <View style={styles.modalView}>
           ...
           style={({ pressed }) => [
            {
              ...
              : Platform.OS === "ios"? 'rgba(147, 176, 237, 0.9)' : 'rgba(147, 176, 237, 1)', // Color normal
            },
            
            styles.openButton,
            { justifyContent: 'flex-start', marginTop: 25,borderTopLeftRadius: 20, 
            borderTopRightRadius:20, borderBottomWidth: 1, borderBottomColor: 'rgba(120, 157, 233, 0.85)' },
          ]}
          onPress={() => {
        ...
        <Pressable
           style={({ pressed }) => [
            ...
            styles.openButton,
            { justifyContent: 'flex-start', marginBottom: 15, borderBottomLeftRadius: 20, 
            borderBottomRightRadius:20, },
          ]}
          onPress={() => {
            router.push("/tecnico/regismantenimiento");
          }}
        >
          {/* Aquí definimos el contenido de cada opción */}

          <Iconify icon="solar:clipboard-text-bold" size={25} color={COLORS.blue}  />
