    ...
    <View style={styles.container}>
      ...
      <View style={styles.column}>
        ...
        <View style={[styles.box, { backgroundColor: COLORS.blue }]}>
          <Text style={[styles.title2, { color: COLORS.white, marginBottom: 5 }]}>Mantenimientos</Text>
          <Text style={[styles.title2, { color: COLORS.white, marginBottom: 35 }]}>Realizados</Text>
          <CircularProgress
            value={4}
            maxValue={5}
            duration={2000}
        ...
        <TouchableOpacity style={[styles.box, { backgroundColor: COLORS.white }]} onPress={() => { router.push("/programar-mantenimiento") }}>
          <Text style={[styles.title2, { color: COLORS.blue, marginBottom: 5 }]}>Reprogramar</Text>
          <Text style={[styles.title2, { color: COLORS.blue, marginBottom: 35 }]}>Mantenimientos</Text>
      ...
      <View style={styles.column}>
        ...
        <View style={[styles.box, { backgroundColor: COLORS.wellow }]}>
          <View style={styles.centeredContent}>
            <Text style={[styles.title3, { color: COLORS.white, marginTop: 0 }]}>Revisiones</Text>
            <View style={styles.row}>
              <Text style={[styles.bigNumber, { color: COLORS.white }]}>2</Text>
              <Iconify icon="eva:alert-triangle-fill" size={57} color="#0C2049" />
            </View>
            <Text style={[styles.title3, { color: COLORS.white }]}>Pendientes</Text>
          </View>
        </View>
        {/* Segunda caja en la segunda columna: proporciona una opción para contactar con el soporte */}
        <View style={[styles.box, { backgroundColor: COLORS.blue }]}>
          <View style={styles.centeredContent}>
            <Text style={[styles.title4, { color: COLORS.white, marginTop: 0 }]}>Soporte</Text>
            <Iconify icon="solar:dialog-2-bold-duotone" size={76} color="#FFFFFF" />
            <Text style={[styles.title5, { color: COLORS.white }]}>Contáctanos</Text>
          </View>
        </View>
        ...
        <View style={[styles.box, { backgroundColor: COLORS.red }]}>
          <View style={styles.centeredContent}>
            <Text style={[styles.title4, { color: COLORS.redst, marginTop: 0 }]}>Reportar Emergencia</Text>
