...
export const Completar_MantenimientoDocument = {"kind":"Document","definitions":[{"kind":"OperationDefinition","operation":"mutation","name":{"kind":"Name","value":"Completar_mantenimiento"},"variableDefinitions":[{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"completarMantenimientoId"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}},{"kind":"VariableDefinition","variable":{"kind":"Variable","name":{"kind":"Name","value":"diagnosticoFinal"}},"type":{"kind":"NonNullType","type":{"kind":"NamedType","name":{"kind":"Name","value":"String"}}}}],"selectionSet":{"kind":"SelectionSet","selections":[{"kind":"Field","name":{"kind":"Name","value":"completar_mantenimiento"},"arguments":[{"kind":"Argument","name":{"kind":"Name","value":"id"},"value":{"kind":"Variable","name":{"kind":"Name","value":"completarMantenimientoId"}}},{"kind":"Argument","name":{"kind":"Name","value":"diagnosticoFinal"},"value":{"kind":"Variable","name":{"kind":"Name","value":"diagnosticoFinal"}}}]}]}}]} as unknown as DocumentNode<Completar_MantenimientoMutation, Completar_MantenimientoMutationVariables>;
