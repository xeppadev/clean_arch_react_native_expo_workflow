          ...
          tabs={[
            {
              ...
              title: "Programados",
              component: () => (
                <ConfirmadosPage data={mantenimientosProgramados} refetch={refetch} />
              ),
            },
            {
              key: "todos",
              title: "Todos",
              component: () => <ConfirmadosPage data={TodosMantenimientosRecientes} refetch={refetch} />,
            },
            {
              key: "pendientes",
              title: "Pendientes",
              component: () => (
                <ConfirmadosPage data={mantenimientosPendientes} refetch={refetch} />
              ),
            },
          ]}
        />
